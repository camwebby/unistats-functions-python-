...
youareell = "data.unistats.ac.uk/api/v4/KIS/Institution/10007791/Courses.json?pageSize=10000"
prefix = "http://"+api_key+":password"+"@"


def getData(resource):
    getURL = prefix+"data.unistats.ac.uk/api/v4/KIS/Institution/10007791/Courses.json?pageSize=10000"
...
##    c = x["KisMode"]
##    try:
##        if getSalary(a,b,c)[0] > 24000 or getSalary(a,b,c)[1] > 24000:
